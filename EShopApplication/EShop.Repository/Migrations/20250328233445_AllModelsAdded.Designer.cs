...
namespace EShop.Repository.Migrations
{
    ...
    [Migration("20250328233445_AllModelsAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Domain.DomainModels.ProductInShoppingCart", b =>
                {
                    ...
                    b.Property<Guid?>("AddedProductId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("AddedShoppingCartId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AddedProductId");

                    b.HasIndex("AddedShoppingCartId");
            ...
            modelBuilder.Entity("EShop.Domain.DomainModels.ProductInShoppingCart", b =>
                {
                    b.HasOne("EShop.Domain.DomainModels.Product", "AddedProduct")
                        .WithMany("AllShoppingCarts")
                        .HasForeignKey("AddedProductId");

                    b.HasOne("EShop.Domain.DomainModels.ShoppingCart", "AddedShoppingCart")
                        .WithMany("AllProducts")
                        .HasForeignKey("AddedShoppingCartId");

                    b.Navigation("AddedProduct");

                    b.Navigation("AddedShoppingCart");
                });

            modelBuilder.Entity("EShop.Domain.DomainModels.ShoppingCart", b =>
                {
                    b.HasOne("EShop.Domain.Identity.EShopUser", "Owner")
                        .WithMany()
